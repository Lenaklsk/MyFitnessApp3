...
import com.example.myfitnessapp3.ui.view.activities.User;
...
public class RegisterUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerUser = (Button) findViewById(R.id.registerUser_button);
       //registerUser.setOnClickListener(this);
        ...
        editTextFullname = (EditText) findViewById(R.id.fullName_editText);
        editTextAge = (EditText) findViewById(R.id.Age_editText);
